            ...
            <div className="message-input-wrapper">
                ...
                <button 
                    ...
                    onClick={props.sendMessage}>
                        <svg xmlns="http://www.w3.org/2000/svg" overflow="visible" preserveAspectRatio="none" viewBox="0 0 24 24" width="20" height="20"><path fill={props.buttonColor} d="M2 21l21-9L2 3v7l15 2-15 2z"></path></svg>
                </button>
            </div>
        </div>
    );
