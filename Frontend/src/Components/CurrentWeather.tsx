...
const getIcon = (id: WeatherType, day: boolean) => {
  switch(id) {
    ...
    case 232:
      return id202;
    case 210: return day ? id210d : id210n;
    case 211:
    case 212:
    case 221:
      return id211;
    case 300: return day ? id300d : id300n;
    case 301:
    case 310:
    case 311:
      return id301;
    ...
    case 321:
      return id302;
    case 500: return day ? id500d : id500n;
    case 501:
    case 511:
    case 520:
    case 521:
    ...
    case 531:
      return id502;
    case 600: return day ? id600d : id600n;
    case 601:
    case 602:
      return id601;
    case 611:
    ...
    case 622: 
      return id616;
    case 701: return id701;
    case 711: return id711;
    case 721: return id721;
    case 731: return id731;
    case 741: return id741;
    case 751:
    case 761:
    case 762:
      return id751;
    case 771: return id771;
    case 781: return id781;
    case 800: return day ? id800d : id800n;
    case 801: return day ? id801d : id801n;
    case 802: return day ? id802d : id802n;
    case 803: return id803;
    case 804: return id804;
  }
}
          ...
          <Row>
            <Col>
              <Row justifyContent='center'>
                <img className="current-weather-icon" src={getIcon(props.weather, props.day)} alt="current-weather-icon"/>
              </Row>
            </Col>
            <Col>
              <Row>
            ...
            {props.forecast.map((item, index) => {
              return (
                <WeatherTile 
                  ...
                  date={item.date}
                  icon={getIcon(item.weather, item.day)}
                  key={index}
                ></WeatherTile>
              );
            })}
